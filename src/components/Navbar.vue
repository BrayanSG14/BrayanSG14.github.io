...
.navbar {
  ...
  /* -webkit-backdrop-filter: blur(6px) saturate(200%) brightness(1.06); */
...
[data-theme="dark"] .navbar {
  ...
  /* backdrop-filter: blur(6px) saturate(180%) brightness(0.9); */
  /* -webkit-backdrop-filter: blur(6px) saturate(180%) brightness(0.9); */
